...
class TokenValidationService:
    ...
    async def validate_and_truncate_text(
        ...
        try:
            ...
            self.logger.error(
                f"[TokenValidationService] Error in token validation: {str(e)}"
            )
            raise e
    ...
    async def check_token_count(
        ...
        try:
            ...
            self.logger.error(
                f"[TokenValidationService] Error checking token count: {str(e)}"
            )
            raise e
    ...
    async def estimate_tokens_for_text_length(
        ...
        try:
            ...
            self.logger.error(
                f"[TokenValidationService] Error estimating text length: {str(e)}"
            )
            raise e
